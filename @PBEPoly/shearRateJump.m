function out = shearRateJump(obj, init_rate, delta_t, min_rate, final_rate, time, initialConditions)
...
if nargin > 5
    ...
    init = obj.steadyShearODE(init_rate);
end
...
shear_rate = @(t) (t<delta_t)*min_rate + (t>=delta_t)*final_rate;

%% Solving the system of ODEs
% Setting tolerance for ODEs
tstart = tic;
odeopts = odeset('RelTol',1e-5,'AbsTol',1e-8,'Stats','on','Events', ...
