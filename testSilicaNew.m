...
parVec = [1.1662 1.1458 -5.3424 0.9566];
% parVec = [4.1263 0.7213 -6.9142 0.8999];
% parVec = parVecBest;

    obj.par.W = (exp(parVec(1))-1)*parVec(2)/0.9;
    obj.par.alfa = 0.9;parVec(2); % scaled by 0.5
    obj.par.b_0 = exp(parVec(3))*0.9/parVec(2); % scaled by 0.5
...
SS_error = norm((stress-shear_stress_SS)./mean(shear_stress_SS))...
